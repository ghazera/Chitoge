...
module.exports.run = (bot, message, args) => {
  ...
  if(!message.content.startsWith(prefix)) return
    ...
    .setColor("RANDOM")
    .setDescription(`<a:rainbowpartner:507491463958102028>  Je suis sur ${bot.guilds.array().length} serveurs. Plus de ${bot.users.array().length} membres m'utilise, et je suis sur ${bot.channels.array().length} channels.`);
